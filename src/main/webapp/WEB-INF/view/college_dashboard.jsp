							...
							<c:forEach items="${adv}" var="comp_add">
								<div class="internship-item"
									...
									<div class="row">
										...
										<div class="col-md-9 truncate-normal">
											<a href="javascript:void(0);"> <span
												...
												id="${comp_add.companyId}" style="color: #33A6F8;">${comp_add.companyName}</span>
											</a>
										</div>
										<div class="col-md-9 truncate-normal">
											<a href=""> <span
												...
												onclick="getCompanyDetails('${comp_add.companyId}');"
												id="${comp_add.companyName}" style="color: #33A6F8;">${comp_add.companyName}</span>
											</a>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div hidden class="col-md-3 text-center">
											<br>
