...
<script src="${pageContext.request.contextPath}/style/dist/js/material.min.js"></script>
<script src="${pageContext.request.contextPath}/style/dist/js/ripples.min.js"></script>
<script src="${pageContext.request.contextPath}/style/dist/jquery.dataTables.min.js"></script>
<script src="${pageContext.request.contextPath}/style/dist/dataTables.responsive.min.js"></script>
<script>
	$.material.init();
</script>
<script src="/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<script src="/plugins/fastclick/fastclick.js"></script>
<script src="${pageContext.request.contextPath}/style/dist/js/app.min.js"></script>
<script src="${pageContext.request.contextPath}/style/dist/js/demo.js"></script>
