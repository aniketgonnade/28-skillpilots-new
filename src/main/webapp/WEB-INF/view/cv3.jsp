...
<div class="row">
    <div class="col-12 text-center">
      <h2 class="fw-bold mt-5">Template 3</h2>
    </div>
  </div>
 	...
 	<div class="cv2 mt-5">
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-8 col-md-10 resume-container">

								<div class="resume-header bg-dark">
									<h1>${student.student_name}</h1>
									<p>
										<%--  <a href="mailto:${student.email_id}">${student.email_id}</a> | 
            <a href="tel:${student.contact}">${student.contact}</a> --%>
										<i class="fas fa-phone"></i> ${student.contact} | <i
											class="fas fa-envelope"></i> ${student.email_id}| <i
											class="fas fa-map-marker-alt"></i> ${student.curr_city}
									</p>
								</div>
								...
								<div class="subsection">
									<p>
										...
										enthusiastic and motivated individual with a strong interest
										in software development and real-world problem solving. <br>I
										am passionate about learning new technologies and applying
										them to create impactful solutions. I have successfully
										completed multiple internships that exposed me to various
										stages of the development lifecycle, including planning,
										coding, testing, and deployment. Through these experiences,
										I've gained hands-on expertise in technologies like <strong>${student.skills}</strong>
										and built a solid foundation in both front-end and back-end
										development. I thrive in collaborative environments and am
										always eager to take on challenges that push me out of my
										comfort zone. My goal is to continuously grow as a developer
										and contribute meaningfully to innovative projects. Outside of
										coding, I enjoy participating in coding competitions,
								...
								<div class="subsection">
									<c:forEach var="studentPasts" items="${studentPast}">
										<div class="two-column mb-2">
											<div>
												<strong>&bull; Qualification : </strong>${studentPasts.category}
												<br> <strong>&bull; Organization :</strong>
												${studentPasts.organization}
											</div>
											<div class="text-right">
												<strong>&bull; Board :</strong> ${studentPasts.board}
												<li>.<b> &bull; Percentage: </b>
													${studentPasts.description}%
												</li>
										...
										<div class="mb-3">
											<div class="d-flex justify-content-between">
												<div>
													...
													<p class="mb-0 text-muted">Position: Intern</p>
												</div>
								...
								<div class="subsection">
									<ul class="highlight">
										<c:forEach var="skill" items="${student.skills.split(',')}">
											<li><i class="fas fa-star"></i> ${skill.trim()}</li>
										</c:forEach>
									</ul>
								</div>
								...
								<div class="subsection">
									<ul class="highlight">
										...
										<li><i class="fas fa-envelope"></i> ${student.email_id}</li>
										<li><i class="fas fa-phone"></i> ${student.contact}</li>
									</ul>
								</div>
...
<input type="hidden" id="templateEnabled" value="${student.isTemplateEnabled()}" /> --%>
     <a href="#" id="btn-cv3-select" class="btn btn-outline-primary me-2"
   onclick="selectTemplate('cv3')" 
   title="Once you select this template you cannot select another template">
   <i class="fa-solid fa-circle-check"></i> Select Template 3
</a> 
     <a href="editCV1" class="btn btn-outline-primary me-2">
       <i class="fas fa-edit"></i> Edit CV3
     </a>
   
 <button onclick="downloadCV3('pdf')" id="download-btn" class="btn download-btn d-none">
