...
<html>
  ...
  <body>
              ...
              <tbody id="tablist">
                <c:forEach var="balanceDetail" items="${balanceDetails}">
                  <tr>
                    <td>
                      <span
                        class="actionSpan pointer"
                        style="color: #1017ef"
                        onclick="viewPkgDetailsClg('pkg','${balanceDetail[1]}')"
                        >${balanceDetail[7]}</span
                      >
                    </td>
                    <td>
                      <fmt:formatDate
                        value="${balanceDetail[2]}"
                        pattern="yyyy-MM-dd"
                      />
                    </td>
                    <td>
                    ...
                    <td>
                      <span
                        class="actionSpan pointer"
                        style="color: #1017ef"
                        onclick="viewPkgDetailsClg('bal','${balanceDetail[0]}')"
                        >View Usages</span
                      >
                    </td>
                  </tr>
    ...
    <!-- js -->
    <%@include file="scriptfiles.jsp"%> <%@include
    file="modal_transactionsAndBalances.jsp"%>
    ...
    <script
      type="text/javascript"
      src="//cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"
    ></script>
