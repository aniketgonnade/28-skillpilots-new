...
uri="http://java.sun.com/jsp/jstl/core" %> <%@include file="user_session.jsp" %>
<!DOCTYPE html>
<html>
  <head>
    <!-- Basic Page Info -->
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.bundle.min.js"></script>
        ...
        <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="company_dashboard">Home</a>
            </li>
  ...
  <div class="row">
    ...
    <!-- Card 4: Internal Internship Requests -->
    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
      <div class="card-box min-height-200px pd-20" data-bgcolor="#265ED7" style="background-color: rgb(38, 94, 215)">
        <div class="d-flex justify-content-between pb-20 text-white">
          <div class="icon h1 text-white">
      ...
      <%@include file="modal_common.jsp"%> <div class="mobile-menu-overlay"></div>
	...
	<div class="main">
		...
		<c:if test="${user.role eq '3' || user.role eq '4' }">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					<c:if test="${not empty com_three_internal_req}">
						...
						<div class="mb-15">
							<table class="data-table table hover">
								...
								<tbody id="tablist">
									<c:forEach items="${com_three_internal_req}" var="com_internal_req">
										<tr>
					...
					<c:if test="${empty com_three_internal_req}">
...
function scheduleInternships(requested_id, team_name) {
    ...
    function dispStudentData2() {
    var userId = document.getElementById("uid").textContent.trim(); // Get the user_id value from the span with id "uid"
    console.log("User ID:", userId);
    // Make an AJAX request to your Spring endpoint
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "/getStudentData/" + encodeURIComponent(userId), true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                document.getElementById("curr_city").textContent = studentData.curr_city;
                document.getElementById("home_city").textContent = studentData.home_city;
                document.getElementById("skills").textContent = studentData.skills;
                document.getElementById("interest").textContent = studentData.interest;
                document.getElementById("hobbies").textContent = studentData.hobbies;
...
function dispStudentData1(studentId) {
    // Make an AJAX request to your Spring endpoint
    console.log(studentId);
    var xhr = new XMLHttpRequest();
    console.log(xhr);
    var url = "${pageContext.request.contextPath}/getStudentDetails/" + encodeURIComponent(studentId);
    ...
    xhr.onreadystatechange = function () {
                ...
                document.getElementById("interest").textContent = studentData.interest;
                document.getElementById("hobbies").textContent = studentData.hobbies;
				document.getElementById("email").textContent=studentData.email_id;
                document.getElementById("contact").textContent=studentData.contact;
                document.getElementById("achievements").textContent = studentData.achievements;
