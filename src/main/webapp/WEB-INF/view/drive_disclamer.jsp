...
<body>
    <div class="content">
       <center> <h1 style="font-weight:600">Instruction</h1></center>
        ...
        <ul class="collection">
                        ...
                        <form action="startDrive" method="get">
    ...
    <script>
        // Function to retrieve student ID from localStorage and set it in the hidden input
        window.onload = function() {
            const storedUserData = localStorage.getItem('userData');
            if (storedUserData) {
                const userData = JSON.parse(storedUserData);
                document.getElementById('studentId').value = userData.id; // Set the studentId
            } else {
