<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    .quotes {
        ...
        animation: moveQuotes 15s linear infinite;
    }
...
<div class="quotes-container">
            <div class="quotes">
                ...
                <span>"Opportunities don't happen, you create them." - Chris Grosser</span>
            </div>
        </div>
							<div class="row">
													...
													<div class="row">
														<div class="col-md-9">
															<h6 class="h5 mb-20" data-toggle="tooltip"
																...
																${companyDrive}	${comp_add.description}
															</h6>
														</div>
...
<a href="https://www.cluematrix.com/" target="_blank" style="color: #2800b4;">
    Cluematrix
</a> Technologies Pvt. Ltd. | Contact: <b>+91-9422926439  
</b>
