						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="addMaterialForm"
									...
									<div class="mb-3">
        <label for="videoLink" class="form-label fw-bold">Video Link (Optional)</label>
        <input type="url" class="form-control" id="videoLink"
            name="videourl" placeholder="Enter YouTube or other video URL" />
    </div>
										...
										<tr>
											...
											<td><c:if test="${user.role eq 7}">
												...
												<button label="ViewPDF" class="btn btn-info"
													...
													Open PDF</button> <c:if test="${not empty material.videourl}">
